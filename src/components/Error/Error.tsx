...
export const Error = ({ text }: IErrorProps) => {
  return (
    <section className="h-screen w-full flex flex-col justify-center items-center bg-gray-800">
      ...
      <div className="bg-blue-500 px-2 -mt-12 text-sm rounded rotate-12 absolute">
        {text}
      </div>
      <button className="mt-8" onClick={() => {}}>
        <p className="relative inline-block text-sm font-medium text-blue-500 group active:text-blue-500 focus:outline-none focus:ring">
