...
A.StrictMode = sh;
A.Suspense = dh;
A.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = wh;
 ...
 */ (function (e) {
  ...
  function r(T) {
    ...
    if (D !== L) {
      T[0] = D;
      e: for (var J = 0, ne = T.length, Lr = ne >>> 1; J < Lr; ) {
        var Dt = 2 * (J + 1) - 1,
          gl = T[Dt],
          At = Dt + 1,
          Dr = T[At];
        if (0 > i(gl, D))
          At < ne && 0 > i(Dr, gl)
            ? ((T[J] = Dr), (T[At] = D), (J = At))
            : ((T[J] = gl), (T[Dt] = D), (J = Dt));
        else if (At < ne && 0 > i(Dr, D)) (T[J] = Dr), (T[At] = D), (J = At);
        else break e;
      }
    }
    return L;
  ...
  function R(T, L) {
    ...
    try {
      for (
        p(L), h = n(u);
        h !== null && (!(h.expirationTime > L) || (T && !he()));

      ) {
        var J = h.callback;
        if (typeof J == "function") {
          (h.callback = null), (m = h.priorityLevel);
          var ne = J(h.expirationTime <= L);
          (L = e.unstable_now()),
      ...
      if (h !== null) var Lr = !0;
        ...
        var Dt = n(a);
        Dt !== null && vl(w, Dt.startTime - L), (Lr = !1);
      }
      return Lr;
    } finally {
      (h = null), (m = D), (g = !1);
...
function tp(e, t, n, r, i) {
  switch (t) {
    ...
    case "pointerover":
      var l = i.pointerId;
      return or.set(l, Mn(or.get(l) || null, e, t, n, r, i)), !0;
    case "gotpointercapture":
      return (
        (l = i.pointerId), sr.set(l, Mn(sr.get(l) || null, e, t, n, r, i)), !0
      );
  }
  return !1;
}
...
function xs(e, t, n, r) {
  if (Ei) {
    var i = Eo(e, t, n, r);
    if (i === null) Al(e, t, r, Ci, n), _u(e, r);
...
function rf(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var i in r) if (!(i in t)) throw Error(C(108, Ah(e) || "Unknown", i));
  return q({}, n, r);
}
function Ri(e) {
  return (
...
function Ft() {
  if (!Ml && Xe !== null) {
    ...
    try {
      ...
      throw (Xe !== null && (Xe = Xe.slice(e + 1)), _c(Ss, Ft), i);
    } finally {
      (U = t), (Ml = !1);
    }
  }
...
function of(e, t, n) {
  (Te[Fe++] = Ye), (Te[Fe++] = Ze), (Te[Fe++] = Wt), (Wt = e);
  var r = Ye;
  e = Ze;
  var i = 32 - Be(r) - 1;
  (r &= ~(1 << i)), (n += 1);
...
function Ao(e, t, n, r) {
  var i = e.stateNode;
  (i.props = n), (i.state = e.memoizedState), (i.refs = ff), Ms(e);
  var l = t.contextType;
  typeof l == "object" && l !== null
    ? (i.context = Ae(l))
...
function hf(e) {
  ...
  function m(d, f, p, w) {
    ...
    if (typeof p == "object" && p !== null) {
      ...
      if (Vn(p) || An(p)) return R !== null ? null : c(d, f, p, w, null);
      qr(d, p);
    }
    return null;
  }
  function g(d, f, p, w, R) {
    ...
    if (typeof w == "object" && w !== null) {
      ...
      if (Vn(w) || An(w)) return (d = d.get(p) || null), c(f, d, w, R, null);
      qr(f, w);
    }
    return null;
  }
  function y(d, f, p, w) {
    for (
      var R = null, k = null, O = f, x = (f = 0), I = null;
      O !== null && x < p.length;
      x++
    ) {
      O.index > x ? ((I = O), (O = null)) : (I = O.sibling);
      var F = m(d, O, p[x], w);
      if (F === null) {
        O === null && (O = I);
        break;
      ...
      e && O && F.alternate === null && t(d, O),
        (f = l(F, f, x)),
        k === null ? (R = F) : (k.sibling = F),
        (k = F),
        (O = I);
    }
    if (x === p.length) return n(d, O), H && It(d, x), R;
    if (O === null) {
      for (; x < p.length; x++)
        (O = h(d, p[x], w)),
          O !== null &&
    ...
    for (O = r(d, O); x < p.length; x++)
      (I = g(O, d, x, p[x], w)),
        I !== null &&
          (e && I.alternate !== null && O.delete(I.key === null ? x : I.key),
          (f = l(I, f, x)),
  ...
  function v(d, f, p, w) {
    ...
    for (
      var k = (R = null), O = f, x = (f = 0), I = null, F = p.next();
      O !== null && !F.done;
      x++, F = p.next()
    ) {
      O.index > x ? ((I = O), (O = null)) : (I = O.sibling);
      var he = m(d, O, F.value, w);
      if (he === null) {
        O === null && (O = I);
        break;
      }
    ...
    if (F.done) return n(d, O), H && It(d, x), R;
    if (O === null) {
      for (; !F.done; x++, F = p.next())
        (F = h(d, F.value, w)),
          F !== null &&
            ((f = l(F, f, x)), k === null ? (R = F) : (k.sibling = F), (k = F));
      return H && It(d, x), R;
    }
    for (O = r(d, O); !F.done; x++, F = p.next())
      (F = g(O, d, x, F.value, w)),
        F !== null &&
          (e && F.alternate !== null && O.delete(F.key === null ? x : F.key),
          (f = l(F, f, x)),
          k === null ? (R = F) : (k.sibling = F),
          (k = F));
    return (
...
function Tf(e, t, n) {
  return qt & 21
    ? ($e(n, t) || ((n = Lc()), (W.lanes |= n), (Kt |= n), (e.baseState = !0)),
      t)
...
function nm(e, t, n) {
  ...
  if (Lf(e)) Df(t, i);
    ...
    (n = af(e, t, i, r)),
      n !== null && ((i = me()), Qe(n, e, r, i), Af(n, t, r));
  }
}
function Lf(e) {
  var t = e.alternate;
...
function ca(e, t, n, r, i) {
  if (e === null) {
    ...
    return typeof l == "function" &&
      ...
      ? ((t.tag = 15), (t.type = l), zf(e, t, l, r, i))
...
function fa(e, t, n, r, i) {
  ...
  if ((vn(t, i), t.stateNode === null))
    li(e, t), df(t, n, r), Ao(t, n, r, i), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      s = t.memoizedProps;
    o.props = s;
...
function da(e, t, n, r, i) {
  return En(), Fs(i), (t.flags |= 256), pe(e, t, n, r), t.child;
}
...
function Gf(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Me(t, e), He(e), r & 512 && n !== null && fn(n, n.return);
      break;
    case 5:
      if (
        (Me(t, e),
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((fe = (a = fe) || c), Me(t, e), (fe = a)) : Me(t, e),
        He(e),
        r & 8192)
      ) {
        if (
...
function Qe(e, t, n, r) {
  ...
  kr(e, n, r),
    (!(z & 2) || e !== ie) &&
      (e === ie && (!(z & 2) && (nl |= n), b === 4 && ht(e, se)),
      Ce(e, r),
      n === 1 && z === 0 && !(t.mode & 1) && ((Pn = G() + 500), Zi && Ft()));
}
function Ce(e, t) {
...
function Yf(e, t) {
  if (((oi = -1), (si = 0), z & 6)) throw Error(C(327));
  var n = e.callbackNode;
      ...
      switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Oo(Mt.bind(null, e, ge, Ge), t);
            break;
          }
          Mt(e, ge, Ge);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Oo(Mt.bind(null, e, ge, Ge), r);
            break;
          }
          Mt(e, ge, Ge);
          break;
...
function Jt(e) {
  ...
  try {
    ...
    (U = r), (De.transition = n), (z = t), !(z & 6) && Ft();
  }
}
function Xs() {
  (xe = dn.current), $(dn);
...
function bf() {
  var e = Ii.current;
  return (Ii.current = Ai), e === null ? Ai : e;
}
function Ys() {
  (b === 0 || b === 3 || b === 2) && (b = 4),
...
function Ui(e, t) {
  ...
  while (1);
  if ((Ds(), (z = n), (Ii.current = r), Y !== null)) throw Error(C(261));
...
function wm(e, t, n, r) {
  ...
  if (Mi) throw ((Mi = !1), (e = Wo), (Wo = null), e);
  return (
    zi & 1 && e.tag !== 0 && gn(),
    (l = e.pendingLanes),
  ...
  if (mt !== null) {
    ...
    try {
      if (((De.transition = null), (U = 16 > e ? 16 : e), mt === null))
        ...
        if (((e = mt), (mt = null), (zi = 0), z & 6)) throw Error(C(331));
        var i = z;
        ...
        if (
          ((z = i), Ft(), Ke && typeof Ke.onPostCommitFiberRoot == "function")
        )
          try {
...
function ui(e, t, n, r, i, l) {
  ...
  if (((r = e), typeof e == "function")) Zs(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case ro:
        return (
          (e = Le(12, n, t, i | 2)), (e.elementType = ro), (e.lanes = l), e
        );
      case io:
        return (e = Le(13, n, t, i)), (e.elementType = io), (e.lanes = l), e;
      case lo:
        return (e = Le(19, n, t, i)), (e.elementType = lo), (e.lanes = l), e;
      case dc:
        return rl(n, i, l, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Es(t, n | 1), Ce(t, G()), !(z & 6) && ((Pn = G() + 500), Ft()));
      }
      break;
    case 13:
      Jt(function () {
      ...
      e.fetchFn = () => {
        ...
        const E = (k) => {
          ...
          p = (k, O, x, I) => {
            ...
            E(F);
            const he = d(F);
            return Promise.resolve(he).then((Lt) => f(k, x, Lt, I));
          };
        let w;
        if (!m.length) w = p([]);
        else if (c) {
          const k = typeof a < "u",
            O = k ? a : Fa(e.options, m);
          w = p(m, k, O);
        } else if (h) {
          const k = typeof a < "u",
          ...
          for (let x = 1; x < m.length; x++)
            w = w.then((I) => {
              if (s && m[x] ? s(m[x], x, m) : !0) {
                const he = k ? g[x] : Fa(e.options, I);
                return p(I, k, he);
              }
              return Promise.resolve(f(I, g[x], m[x]));
            });
        }
...
class qm extends Nr {
  ...
  onSubscribe() {
    this.listeners.length === 1 &&
      ...
      La(this.currentQuery, this.options) && this.executeFetch(),
      this.updateTimers());
  }
  onUnsubscribe() {
  ...
  return (
    ...
    (t && typeof window < "u"
      ? (window.ReactQueryClientContext ||
          (window.ReactQueryClientContext = Aa),
        window.ReactQueryClientContext)
      : Aa)
  );
}
...
function xy(e, t, n, r) {
  ...
  let v = {
    ...
    listen(E) {
      ...
      return (
        i.addEventListener(Ia, h),
        (u = E),
        () => {
          i.removeEventListener(Ia, h), (u = null);
        }
      );
    },
    createHref(E) {
...
function ky(e, t, n) {
  ...
  Py(l);
  let o = null;
  for (let s = 0; o == null && s < l.length; ++s) o = Ay(l[s], zy(i));
  return o;
}
function Sd(e, t, n, r) {
  ...
  let i = (l, o, s) => {
    ...
    l.children &&
      ...
      Sd(l.children, t, c, a)),
      !(l.path == null && !l.index) &&
        t.push({ path: a, score: Ly(a, l.index), routesMeta: c });
  };
  return (
    e.forEach((l, o) => {
      var s;
...
const Pd = P.createContext(null),
  ...
  Fn = P.createContext({ outlet: null, matches: [] }),
...
const xv = "/innova/dist/assets/menu-8b916bb9.svg",
  kv = "/innova/dist/assets/close-b3724619.svg",
  Pv = () => {
    const e = Ln(),
      [t, n] = P.useState(!1);
    return N("nav", {
      ...
      children: j("div", {
        ...
        children: [
          N(zt, {
            to: "/",
            children: N("h1", {
              className: "text-[#FAE314] font-bold text-2xl cursor-pointer",
              ...
              children: j("ul", {
                ...
                children: [
                  N("li", {
                    ...
                    children: N(zt, { to: "/", children: "Personagens" }),
                  }),
              ...
              localStorage.getItem("last-url") &&
                N("li", {
                  className: `ml-8 hover:text-[#FAE314] ease-linear duration-300  ${
                    e.pathname.includes("character") && "text-[#FAE314]"
                  }`,
                  children: N(zt, {
                    to: localStorage.getItem("last-url") ?? "/",
                    children: "Último acesso",
  ...
  _d = ({ text: e }) =>
    j("section", {
      ...
      children: [
        ...
        N("div", {
          className:
            "bg-[#FAE314] px-2 -mt-12 text-sm rounded rotate-12 absolute",
          children: e,
        }),
        N("button", {
          className: "mt-8",
          ...
          children: j("p", {
            className:
              "relative inline-block text-sm font-medium text-[#FAE314] group active:text-[#FAE314] focus:outline-none focus:ring",
            children: [
              N("span", {
                className:
                  "absolute inset-0 transition-transform translate-x-0.5 translate-y-0.5 bg-[#FAE314] group-hover:translate-y-0 group-hover:translate-x-0",
              }),
              N("span", {
...
const Ov = "/innova/dist/assets/attack-clones-cef846e9.jpg",
  Nv = "/innova/dist/assets/empire-strikes-13284492.jpg",
  _v = "/innova/dist/assets/new-hope-9adbb3b0.jpg",
  Tv = "/innova/dist/assets/phantom-menace-482642b2.jpg",
  Fv = "/innova/dist/assets/return-jedi-1482811d.jpg",
  Lv = "/innova/dist/assets/revenge-sith-150b0cef.jpg";
class Dv {
  constructor() {
...
function Jd(e, t) {
  return e && !A0(t) ? I0(e, t) : t;
}
const M0 = qe.isStandardBrowserEnv
  ? (function () {
...
class hu {
  constructor(t) {
    ...
    this.promise.then((i) => {
      ...
      t(function (l, o, s) {
        r.reason || ((r.reason = new Fr(l, o, s)), n(r.reason));
      });
  }
  throwIfRequested() {
...
const K0 = te,
  ...
  X0 = (e) => pu.get(`/films/${e}`),
  Y0 = "/innova/dist/assets/luke-ce4fa1fd.jpg",
  Z0 = "/innova/dist/assets/vader-a87a019c.png",
  b0 = "/innova/dist/assets/kenobi-256a09ab.png",
  eg = "/innova/dist/assets/beru-e2cc6ccf.jpg",
  tg = "/innova/dist/assets/c3po-a97acc45.png",
  ng = "/innova/dist/assets/leia-39643343.jpg",
  rg = "/innova/dist/assets/r5d4-2589d937.png",
  ig = "/innova/dist/assets/r2d2-8addea5e.png",
  lg = "/innova/dist/assets/owen-4df417f4.png",
  og = "/innova/dist/assets/biggs-e4cae5fb.png";
class Yd {
  constructor() {
    le(this, "luke");
    le(this, "vader");
...
const sg = "/innova/dist/assets/movie-icon-c504a60f.svg",
        ...
        j("div", {
          ...
          children: [
            ...
            N("div", {
              ...
              children: o.map((y) => N(Av, { movie: y }, y.title)),
            }),
          ],
        }),
      ],
        ...
        j("div", {
          ...
          children: [
            ...
            N("input", {
              type: "search",
              id: "default-search",
              className: `${cg.input} block w-full p-4 pl-10 text-sm text-white border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#FAE314] focus:border-[#FAE314] dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#FAE314] dark:focus:border-[#FAE314]`,
  ...
  pg = () => {
    ...
    return j("section", {
      className: "max-w-7xl w-full min-h-screen flex flex-col pt-16 pb-4",
      children: [
  ...
  mg = () =>
    j("section", {
      ...
      children: [
        ...
        N("div", {
          className: "bg-[#FAE314] px-2 text-sm rounded rotate-12 absolute",
          ...
          children: j("p", {
            ...
            children: [
              ...
              N("span", {
                ...
                children: N(zt, { to: "/", children: "Voltar ao Inicio" }),
              }),
            ],
          }),
        }),
